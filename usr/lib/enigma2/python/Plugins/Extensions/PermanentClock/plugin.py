...
SKIN = """
	<screen position="0,0" size="120,30" zPosition="-1" backgroundColor="#ff000000" title="Permanent Clock" flags="wfNoBorder">
		<widget source="global.CurrentTime" render="Label" position="1,1" size="120,30" backgroundColor="#ff000000" transparent="1" zPosition="0" foregroundColor="#00f0f0f0" font="Regular;26" valign="center" halign="center">
...
SKIN0 = """
	<screen position="0,0" size="120,30" zPosition="-1" backgroundColor="#ff000000" title="Permanent Clock" flags="wfNoBorder">
		<widget source="global.CurrentTime" render="Label" position="1,1" size="120,30" backgroundColor="#ff000000" transparent="1" zPosition="0" foregroundColor="#00ffc000"  font="Regular;26" valign="center" halign="center">
			<convert type="ClockToText">Default</convert>
		</widget>
	</screen>"""
##############################################################################
SKINL = """
	<screen position="0,0" size="235,48" zPosition="-1" backgroundColor="#ff000000" title="Permanent Clock" flags="wfNoBorder">
		<widget source="global.CurrentTime" render="Label" position="1,1" size="180,45" backgroundColor="#ff000000" transparent="1" zPosition="0" foregroundColor="#00f0f0f0" font="Regular;39" valign="center" halign="right">
			<convert type="ClockToText">Default</convert>
		</widget>
		<widget source="global.CurrentTime" render="Label" position="181,14" size="50,30" font="Regular;22" backgroundColor="#ff000000" transparent="1" zPosition="0" foregroundColor="#00f0f0f0" halign="left">
			<convert type="ClockToText">Format::%S</convert>
		</widget>	</screen>"""
##############################################################################
SKIN0L = """
	<screen position="0,0" size="235,55" zPosition="-1" backgroundColor="#ff000000" title="Permanent Clock" flags="wfNoBorder">
		<widget source="global.CurrentTime" render="Label" position="1,1" size="180,55" backgroundColor="#ff000000" transparent="1" zPosition="0" foregroundColor="#00ffc000" font="Regular;52" valign="center" halign="right">
			<convert type="ClockToText">Default</convert>
		</widget>
	</screen>"""
##############################################################################
